...
getSupportedProfiles webgl_compressed_texture_astc
  = js_getSupportedProfiles webgl_compressed_texture_astc

foreign import js_getSupportedProfiles :: WEBGL_compressed_texture_astc
                                       -> Effect (Array String)
...
getExtensionWEBGL_compressed_texture_astc gl
  = let
    ...
    in
      do
        res <- js_getExtensionWEBGL_compressed_texture_astc gl0
        pure (toMaybe res)

foreign import js_getExtensionWEBGL_compressed_texture_astc :: WebGLRenderingContext
                                                            -> Effect (Nullable WEBGL_compressed_texture_astc)
