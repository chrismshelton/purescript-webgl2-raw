...
gl_READ_BUFFER = 3074.0

gl_UNPACK_ROW_LENGTH :: GLenum
gl_UNPACK_ROW_LENGTH = 3314.0

gl_UNPACK_SKIP_ROWS :: GLenum
gl_UNPACK_SKIP_ROWS = 3315.0

gl_UNPACK_SKIP_PIXELS :: GLenum
gl_UNPACK_SKIP_PIXELS = 3316.0

gl_PACK_ROW_LENGTH :: GLenum
gl_PACK_ROW_LENGTH = 3330.0

gl_PACK_SKIP_ROWS :: GLenum
gl_PACK_SKIP_ROWS = 3331.0

gl_PACK_SKIP_PIXELS :: GLenum
gl_PACK_SKIP_PIXELS = 3332.0
...
gl_TEXTURE_BINDING_3D = 32874.0

gl_UNPACK_SKIP_IMAGES :: GLenum
gl_UNPACK_SKIP_IMAGES = 32877.0

gl_UNPACK_IMAGE_HEIGHT :: GLenum
gl_UNPACK_IMAGE_HEIGHT = 32878.0

gl_TEXTURE_3D :: GLenum
gl_TEXTURE_3D = 32879.0

gl_TEXTURE_WRAP_R :: GLenum
gl_TEXTURE_WRAP_R = 32882.0

gl_MAX_3D_TEXTURE_SIZE :: GLenum
gl_MAX_3D_TEXTURE_SIZE = 32883.0

gl_UNSIGNED_INT_2_10_10_10_REV :: GLenum
gl_UNSIGNED_INT_2_10_10_10_REV = 33640.0

gl_MAX_ELEMENTS_VERTICES :: GLenum
gl_MAX_ELEMENTS_VERTICES = 33000.0

gl_MAX_ELEMENTS_INDICES :: GLenum
gl_MAX_ELEMENTS_INDICES = 33001.0

gl_TEXTURE_MIN_LOD :: GLenum
gl_TEXTURE_MIN_LOD = 33082.0

gl_TEXTURE_MAX_LOD :: GLenum
gl_TEXTURE_MAX_LOD = 33083.0

gl_TEXTURE_BASE_LEVEL :: GLenum
gl_TEXTURE_BASE_LEVEL = 33084.0

gl_TEXTURE_MAX_LEVEL :: GLenum
gl_TEXTURE_MAX_LEVEL = 33085.0
...
gl_DEPTH_COMPONENT24 = 33190.0

gl_MAX_TEXTURE_LOD_BIAS :: GLenum
gl_MAX_TEXTURE_LOD_BIAS = 34045.0

gl_TEXTURE_COMPARE_MODE :: GLenum
gl_TEXTURE_COMPARE_MODE = 34892.0

gl_TEXTURE_COMPARE_FUNC :: GLenum
gl_TEXTURE_COMPARE_FUNC = 34893.0

gl_CURRENT_QUERY :: GLenum
gl_CURRENT_QUERY = 34917.0

gl_QUERY_RESULT :: GLenum
gl_QUERY_RESULT = 34918.0

gl_QUERY_RESULT_AVAILABLE :: GLenum
gl_QUERY_RESULT_AVAILABLE = 34919.0

gl_STREAM_READ :: GLenum
gl_STREAM_READ = 35041.0

gl_STREAM_COPY :: GLenum
gl_STREAM_COPY = 35042.0

gl_STATIC_READ :: GLenum
gl_STATIC_READ = 35045.0

gl_STATIC_COPY :: GLenum
gl_STATIC_COPY = 35046.0

gl_DYNAMIC_READ :: GLenum
gl_DYNAMIC_READ = 35049.0

gl_DYNAMIC_COPY :: GLenum
gl_DYNAMIC_COPY = 35050.0

gl_MAX_DRAW_BUFFERS :: GLenum
gl_MAX_DRAW_BUFFERS = 34852.0

gl_DRAW_BUFFER0 :: GLenum
gl_DRAW_BUFFER0 = 34853.0

gl_DRAW_BUFFER1 :: GLenum
gl_DRAW_BUFFER1 = 34854.0

gl_DRAW_BUFFER2 :: GLenum
gl_DRAW_BUFFER2 = 34855.0

gl_DRAW_BUFFER3 :: GLenum
gl_DRAW_BUFFER3 = 34856.0

gl_DRAW_BUFFER4 :: GLenum
gl_DRAW_BUFFER4 = 34857.0

gl_DRAW_BUFFER5 :: GLenum
gl_DRAW_BUFFER5 = 34858.0

gl_DRAW_BUFFER6 :: GLenum
gl_DRAW_BUFFER6 = 34859.0

gl_DRAW_BUFFER7 :: GLenum
gl_DRAW_BUFFER7 = 34860.0

gl_DRAW_BUFFER8 :: GLenum
gl_DRAW_BUFFER8 = 34861.0

gl_DRAW_BUFFER9 :: GLenum
gl_DRAW_BUFFER9 = 34862.0

gl_DRAW_BUFFER10 :: GLenum
gl_DRAW_BUFFER10 = 34863.0

gl_DRAW_BUFFER11 :: GLenum
gl_DRAW_BUFFER11 = 34864.0

gl_DRAW_BUFFER12 :: GLenum
gl_DRAW_BUFFER12 = 34865.0

gl_DRAW_BUFFER13 :: GLenum
gl_DRAW_BUFFER13 = 34866.0

gl_DRAW_BUFFER14 :: GLenum
gl_DRAW_BUFFER14 = 34867.0

gl_DRAW_BUFFER15 :: GLenum
gl_DRAW_BUFFER15 = 34868.0

gl_MAX_FRAGMENT_UNIFORM_COMPONENTS :: GLenum
gl_MAX_FRAGMENT_UNIFORM_COMPONENTS = 35657.0

gl_MAX_VERTEX_UNIFORM_COMPONENTS :: GLenum
gl_MAX_VERTEX_UNIFORM_COMPONENTS = 35658.0

gl_SAMPLER_3D :: GLenum
gl_SAMPLER_3D = 35679.0

gl_SAMPLER_2D_SHADOW :: GLenum
gl_SAMPLER_2D_SHADOW = 35682.0

gl_FRAGMENT_SHADER_DERIVATIVE_HINT :: GLenum
gl_FRAGMENT_SHADER_DERIVATIVE_HINT = 35723.0

gl_PIXEL_PACK_BUFFER :: GLenum
gl_PIXEL_PACK_BUFFER = 35051.0

gl_PIXEL_UNPACK_BUFFER :: GLenum
gl_PIXEL_UNPACK_BUFFER = 35052.0

gl_PIXEL_PACK_BUFFER_BINDING :: GLenum
gl_PIXEL_PACK_BUFFER_BINDING = 35053.0

gl_PIXEL_UNPACK_BUFFER_BINDING :: GLenum
gl_PIXEL_UNPACK_BUFFER_BINDING = 35055.0

gl_FLOAT_MAT2x3 :: GLenum
gl_FLOAT_MAT2x3 = 35685.0

gl_FLOAT_MAT2x4 :: GLenum
gl_FLOAT_MAT2x4 = 35686.0

gl_FLOAT_MAT3x2 :: GLenum
gl_FLOAT_MAT3x2 = 35687.0

gl_FLOAT_MAT3x4 :: GLenum
gl_FLOAT_MAT3x4 = 35688.0

gl_FLOAT_MAT4x2 :: GLenum
gl_FLOAT_MAT4x2 = 35689.0

gl_FLOAT_MAT4x3 :: GLenum
gl_FLOAT_MAT4x3 = 35690.0
...
gl_SRGB8_ALPHA8 = 35907.0

gl_COMPARE_REF_TO_TEXTURE :: GLenum
gl_COMPARE_REF_TO_TEXTURE = 34894.0
...
gl_VERTEX_ATTRIB_ARRAY_INTEGER = 35069.0

gl_MAX_ARRAY_TEXTURE_LAYERS :: GLenum
gl_MAX_ARRAY_TEXTURE_LAYERS = 35071.0

gl_MIN_PROGRAM_TEXEL_OFFSET :: GLenum
gl_MIN_PROGRAM_TEXEL_OFFSET = 35076.0

gl_MAX_PROGRAM_TEXEL_OFFSET :: GLenum
gl_MAX_PROGRAM_TEXEL_OFFSET = 35077.0

gl_MAX_VARYING_COMPONENTS :: GLenum
gl_MAX_VARYING_COMPONENTS = 35659.0

gl_TEXTURE_2D_ARRAY :: GLenum
gl_TEXTURE_2D_ARRAY = 35866.0

gl_TEXTURE_BINDING_2D_ARRAY :: GLenum
gl_TEXTURE_BINDING_2D_ARRAY = 35869.0

gl_R11F_G11F_B10F :: GLenum
gl_R11F_G11F_B10F = 35898.0

gl_UNSIGNED_INT_10F_11F_11F_REV :: GLenum
gl_UNSIGNED_INT_10F_11F_11F_REV = 35899.0

gl_RGB9_E5 :: GLenum
gl_RGB9_E5 = 35901.0

gl_UNSIGNED_INT_5_9_9_9_REV :: GLenum
gl_UNSIGNED_INT_5_9_9_9_REV = 35902.0

gl_TRANSFORM_FEEDBACK_BUFFER_MODE :: GLenum
gl_TRANSFORM_FEEDBACK_BUFFER_MODE = 35967.0

gl_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS :: GLenum
gl_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS = 35968.0

gl_TRANSFORM_FEEDBACK_VARYINGS :: GLenum
gl_TRANSFORM_FEEDBACK_VARYINGS = 35971.0

gl_TRANSFORM_FEEDBACK_BUFFER_START :: GLenum
gl_TRANSFORM_FEEDBACK_BUFFER_START = 35972.0

gl_TRANSFORM_FEEDBACK_BUFFER_SIZE :: GLenum
gl_TRANSFORM_FEEDBACK_BUFFER_SIZE = 35973.0

gl_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN :: GLenum
gl_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN = 35976.0

gl_RASTERIZER_DISCARD :: GLenum
gl_RASTERIZER_DISCARD = 35977.0

gl_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS :: GLenum
gl_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS = 35978.0

gl_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS :: GLenum
gl_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS = 35979.0

gl_INTERLEAVED_ATTRIBS :: GLenum
gl_INTERLEAVED_ATTRIBS = 35980.0

gl_SEPARATE_ATTRIBS :: GLenum
gl_SEPARATE_ATTRIBS = 35981.0

gl_TRANSFORM_FEEDBACK_BUFFER :: GLenum
gl_TRANSFORM_FEEDBACK_BUFFER = 35982.0

gl_TRANSFORM_FEEDBACK_BUFFER_BINDING :: GLenum
gl_TRANSFORM_FEEDBACK_BUFFER_BINDING = 35983.0
...
gl_RED_INTEGER = 36244.0

gl_RGB_INTEGER :: GLenum
gl_RGB_INTEGER = 36248.0

gl_RGBA_INTEGER :: GLenum
gl_RGBA_INTEGER = 36249.0

gl_SAMPLER_2D_ARRAY :: GLenum
gl_SAMPLER_2D_ARRAY = 36289.0

gl_SAMPLER_2D_ARRAY_SHADOW :: GLenum
gl_SAMPLER_2D_ARRAY_SHADOW = 36292.0

gl_SAMPLER_CUBE_SHADOW :: GLenum
gl_SAMPLER_CUBE_SHADOW = 36293.0

gl_UNSIGNED_INT_VEC2 :: GLenum
gl_UNSIGNED_INT_VEC2 = 36294.0

gl_UNSIGNED_INT_VEC3 :: GLenum
gl_UNSIGNED_INT_VEC3 = 36295.0

gl_UNSIGNED_INT_VEC4 :: GLenum
gl_UNSIGNED_INT_VEC4 = 36296.0

gl_INT_SAMPLER_2D :: GLenum
gl_INT_SAMPLER_2D = 36298.0

gl_INT_SAMPLER_3D :: GLenum
gl_INT_SAMPLER_3D = 36299.0

gl_INT_SAMPLER_CUBE :: GLenum
gl_INT_SAMPLER_CUBE = 36300.0

gl_INT_SAMPLER_2D_ARRAY :: GLenum
gl_INT_SAMPLER_2D_ARRAY = 36303.0

gl_UNSIGNED_INT_SAMPLER_2D :: GLenum
gl_UNSIGNED_INT_SAMPLER_2D = 36306.0

gl_UNSIGNED_INT_SAMPLER_3D :: GLenum
gl_UNSIGNED_INT_SAMPLER_3D = 36307.0

gl_UNSIGNED_INT_SAMPLER_CUBE :: GLenum
gl_UNSIGNED_INT_SAMPLER_CUBE = 36308.0

gl_UNSIGNED_INT_SAMPLER_2D_ARRAY :: GLenum
gl_UNSIGNED_INT_SAMPLER_2D_ARRAY = 36311.0

gl_DEPTH_COMPONENT32F :: GLenum
gl_DEPTH_COMPONENT32F = 36012.0

gl_DEPTH32F_STENCIL8 :: GLenum
gl_DEPTH32F_STENCIL8 = 36013.0

gl_FLOAT_32_UNSIGNED_INT_24_8_REV :: GLenum
gl_FLOAT_32_UNSIGNED_INT_24_8_REV = 36269.0

gl_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING = 33296.0

gl_FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE = 33297.0

gl_FRAMEBUFFER_ATTACHMENT_RED_SIZE :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_RED_SIZE = 33298.0

gl_FRAMEBUFFER_ATTACHMENT_GREEN_SIZE :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_GREEN_SIZE = 33299.0

gl_FRAMEBUFFER_ATTACHMENT_BLUE_SIZE :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_BLUE_SIZE = 33300.0

gl_FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE = 33301.0

gl_FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE = 33302.0

gl_FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE = 33303.0

gl_FRAMEBUFFER_DEFAULT :: GLenum
gl_FRAMEBUFFER_DEFAULT = 33304.0

gl_UNSIGNED_INT_24_8 :: GLenum
gl_UNSIGNED_INT_24_8 = 34042.0

gl_DEPTH24_STENCIL8 :: GLenum
gl_DEPTH24_STENCIL8 = 35056.0

gl_UNSIGNED_NORMALIZED :: GLenum
gl_UNSIGNED_NORMALIZED = 35863.0

gl_DRAW_FRAMEBUFFER_BINDING :: GLenum
gl_DRAW_FRAMEBUFFER_BINDING = 36006.0

gl_READ_FRAMEBUFFER :: GLenum
gl_READ_FRAMEBUFFER = 36008.0

gl_DRAW_FRAMEBUFFER :: GLenum
gl_DRAW_FRAMEBUFFER = 36009.0

gl_READ_FRAMEBUFFER_BINDING :: GLenum
gl_READ_FRAMEBUFFER_BINDING = 36010.0

gl_RENDERBUFFER_SAMPLES :: GLenum
gl_RENDERBUFFER_SAMPLES = 36011.0

gl_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER :: GLenum
gl_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER = 36052.0

gl_MAX_COLOR_ATTACHMENTS :: GLenum
gl_MAX_COLOR_ATTACHMENTS = 36063.0

gl_COLOR_ATTACHMENT1 :: GLenum
gl_COLOR_ATTACHMENT1 = 36065.0

gl_COLOR_ATTACHMENT2 :: GLenum
gl_COLOR_ATTACHMENT2 = 36066.0

gl_COLOR_ATTACHMENT3 :: GLenum
gl_COLOR_ATTACHMENT3 = 36067.0

gl_COLOR_ATTACHMENT4 :: GLenum
gl_COLOR_ATTACHMENT4 = 36068.0

gl_COLOR_ATTACHMENT5 :: GLenum
gl_COLOR_ATTACHMENT5 = 36069.0

gl_COLOR_ATTACHMENT6 :: GLenum
gl_COLOR_ATTACHMENT6 = 36070.0

gl_COLOR_ATTACHMENT7 :: GLenum
gl_COLOR_ATTACHMENT7 = 36071.0

gl_COLOR_ATTACHMENT8 :: GLenum
gl_COLOR_ATTACHMENT8 = 36072.0

gl_COLOR_ATTACHMENT9 :: GLenum
gl_COLOR_ATTACHMENT9 = 36073.0

gl_COLOR_ATTACHMENT10 :: GLenum
gl_COLOR_ATTACHMENT10 = 36074.0

gl_COLOR_ATTACHMENT11 :: GLenum
gl_COLOR_ATTACHMENT11 = 36075.0

gl_COLOR_ATTACHMENT12 :: GLenum
gl_COLOR_ATTACHMENT12 = 36076.0

gl_COLOR_ATTACHMENT13 :: GLenum
gl_COLOR_ATTACHMENT13 = 36077.0

gl_COLOR_ATTACHMENT14 :: GLenum
gl_COLOR_ATTACHMENT14 = 36078.0

gl_COLOR_ATTACHMENT15 :: GLenum
gl_COLOR_ATTACHMENT15 = 36079.0

gl_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE :: GLenum
gl_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE = 36182.0

gl_MAX_SAMPLES :: GLenum
gl_MAX_SAMPLES = 36183.0

gl_HALF_FLOAT :: GLenum
gl_HALF_FLOAT = 5131.0

gl_RG :: GLenum
gl_RG = 33319.0

gl_RG_INTEGER :: GLenum
gl_RG_INTEGER = 33320.0
...
gl_VERTEX_ARRAY_BINDING = 34229.0

gl_R8_SNORM :: GLenum
gl_R8_SNORM = 36756.0

gl_RG8_SNORM :: GLenum
gl_RG8_SNORM = 36757.0

gl_RGB8_SNORM :: GLenum
gl_RGB8_SNORM = 36758.0

gl_RGBA8_SNORM :: GLenum
gl_RGBA8_SNORM = 36759.0

gl_SIGNED_NORMALIZED :: GLenum
gl_SIGNED_NORMALIZED = 36764.0

gl_COPY_READ_BUFFER :: GLenum
gl_COPY_READ_BUFFER = 36662.0

gl_COPY_WRITE_BUFFER :: GLenum
gl_COPY_WRITE_BUFFER = 36663.0

gl_COPY_READ_BUFFER_BINDING :: GLenum
gl_COPY_READ_BUFFER_BINDING = 36662.0

gl_COPY_WRITE_BUFFER_BINDING :: GLenum
gl_COPY_WRITE_BUFFER_BINDING = 36663.0

gl_UNIFORM_BUFFER :: GLenum
gl_UNIFORM_BUFFER = 35345.0

gl_UNIFORM_BUFFER_BINDING :: GLenum
gl_UNIFORM_BUFFER_BINDING = 35368.0

gl_UNIFORM_BUFFER_START :: GLenum
gl_UNIFORM_BUFFER_START = 35369.0

gl_UNIFORM_BUFFER_SIZE :: GLenum
gl_UNIFORM_BUFFER_SIZE = 35370.0

gl_MAX_VERTEX_UNIFORM_BLOCKS :: GLenum
gl_MAX_VERTEX_UNIFORM_BLOCKS = 35371.0

gl_MAX_FRAGMENT_UNIFORM_BLOCKS :: GLenum
gl_MAX_FRAGMENT_UNIFORM_BLOCKS = 35373.0

gl_MAX_COMBINED_UNIFORM_BLOCKS :: GLenum
gl_MAX_COMBINED_UNIFORM_BLOCKS = 35374.0

gl_MAX_UNIFORM_BUFFER_BINDINGS :: GLenum
gl_MAX_UNIFORM_BUFFER_BINDINGS = 35375.0

gl_MAX_UNIFORM_BLOCK_SIZE :: GLenum
gl_MAX_UNIFORM_BLOCK_SIZE = 35376.0

gl_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS :: GLenum
gl_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS = 35377.0

gl_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS :: GLenum
gl_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS = 35379.0

gl_UNIFORM_BUFFER_OFFSET_ALIGNMENT :: GLenum
gl_UNIFORM_BUFFER_OFFSET_ALIGNMENT = 35380.0

gl_ACTIVE_UNIFORM_BLOCKS :: GLenum
gl_ACTIVE_UNIFORM_BLOCKS = 35382.0

gl_UNIFORM_TYPE :: GLenum
gl_UNIFORM_TYPE = 35383.0

gl_UNIFORM_SIZE :: GLenum
gl_UNIFORM_SIZE = 35384.0

gl_UNIFORM_BLOCK_INDEX :: GLenum
gl_UNIFORM_BLOCK_INDEX = 35386.0

gl_UNIFORM_OFFSET :: GLenum
gl_UNIFORM_OFFSET = 35387.0

gl_UNIFORM_ARRAY_STRIDE :: GLenum
gl_UNIFORM_ARRAY_STRIDE = 35388.0

gl_UNIFORM_MATRIX_STRIDE :: GLenum
gl_UNIFORM_MATRIX_STRIDE = 35389.0

gl_UNIFORM_IS_ROW_MAJOR :: GLenum
gl_UNIFORM_IS_ROW_MAJOR = 35390.0

gl_UNIFORM_BLOCK_BINDING :: GLenum
gl_UNIFORM_BLOCK_BINDING = 35391.0

gl_UNIFORM_BLOCK_DATA_SIZE :: GLenum
gl_UNIFORM_BLOCK_DATA_SIZE = 35392.0

gl_UNIFORM_BLOCK_ACTIVE_UNIFORMS :: GLenum
gl_UNIFORM_BLOCK_ACTIVE_UNIFORMS = 35394.0

gl_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES :: GLenum
gl_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES = 35395.0

gl_UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER :: GLenum
gl_UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER = 35396.0

gl_UNIFORM_BLOCK_REFERENCED_BY_FRAGMENT_SHADER :: GLenum
gl_UNIFORM_BLOCK_REFERENCED_BY_FRAGMENT_SHADER = 35398.0

gl_INVALID_INDEX :: GLenum
gl_INVALID_INDEX = 4.294967295e9

gl_MAX_VERTEX_OUTPUT_COMPONENTS :: GLenum
gl_MAX_VERTEX_OUTPUT_COMPONENTS = 37154.0

gl_MAX_FRAGMENT_INPUT_COMPONENTS :: GLenum
gl_MAX_FRAGMENT_INPUT_COMPONENTS = 37157.0

gl_MAX_SERVER_WAIT_TIMEOUT :: GLenum
gl_MAX_SERVER_WAIT_TIMEOUT = 37137.0

gl_OBJECT_TYPE :: GLenum
gl_OBJECT_TYPE = 37138.0

gl_SYNC_CONDITION :: GLenum
gl_SYNC_CONDITION = 37139.0

gl_SYNC_STATUS :: GLenum
gl_SYNC_STATUS = 37140.0

gl_SYNC_FLAGS :: GLenum
gl_SYNC_FLAGS = 37141.0

gl_SYNC_FENCE :: GLenum
gl_SYNC_FENCE = 37142.0

gl_SYNC_GPU_COMMANDS_COMPLETE :: GLenum
gl_SYNC_GPU_COMMANDS_COMPLETE = 37143.0

gl_UNSIGNALED :: GLenum
gl_UNSIGNALED = 37144.0

gl_SIGNALED :: GLenum
gl_SIGNALED = 37145.0

gl_ALREADY_SIGNALED :: GLenum
gl_ALREADY_SIGNALED = 37146.0

gl_TIMEOUT_EXPIRED :: GLenum
gl_TIMEOUT_EXPIRED = 37147.0

gl_CONDITION_SATISFIED :: GLenum
gl_CONDITION_SATISFIED = 37148.0

gl_WAIT_FAILED :: GLenum
gl_WAIT_FAILED = 37149.0

gl_SYNC_FLUSH_COMMANDS_BIT :: GLenum
gl_SYNC_FLUSH_COMMANDS_BIT = 1.0

gl_VERTEX_ATTRIB_ARRAY_DIVISOR :: GLenum
gl_VERTEX_ATTRIB_ARRAY_DIVISOR = 35070.0

gl_ANY_SAMPLES_PASSED :: GLenum
gl_ANY_SAMPLES_PASSED = 35887.0

gl_ANY_SAMPLES_PASSED_CONSERVATIVE :: GLenum
gl_ANY_SAMPLES_PASSED_CONSERVATIVE = 36202.0

gl_SAMPLER_BINDING :: GLenum
gl_SAMPLER_BINDING = 35097.0

gl_RGB10_A2UI :: GLenum
gl_RGB10_A2UI = 36975.0

gl_INT_2_10_10_10_REV :: GLenum
gl_INT_2_10_10_10_REV = 36255.0

gl_TRANSFORM_FEEDBACK :: GLenum
gl_TRANSFORM_FEEDBACK = 36386.0

gl_TRANSFORM_FEEDBACK_PAUSED :: GLenum
gl_TRANSFORM_FEEDBACK_PAUSED = 36387.0

gl_TRANSFORM_FEEDBACK_ACTIVE :: GLenum
gl_TRANSFORM_FEEDBACK_ACTIVE = 36388.0

gl_TRANSFORM_FEEDBACK_BINDING :: GLenum
gl_TRANSFORM_FEEDBACK_BINDING = 36389.0

gl_TEXTURE_IMMUTABLE_FORMAT :: GLenum
gl_TEXTURE_IMMUTABLE_FORMAT = 37167.0

gl_MAX_ELEMENT_INDEX :: GLenum
gl_MAX_ELEMENT_INDEX = 36203.0

gl_TEXTURE_IMMUTABLE_LEVELS :: GLenum
gl_TEXTURE_IMMUTABLE_LEVELS = 33503.0

gl_TIMEOUT_IGNORED :: GLint64
gl_TIMEOUT_IGNORED = -1.0

gl_MAX_CLIENT_WAIT_TIMEOUT_WEBGL :: GLenum
gl_MAX_CLIENT_WAIT_TIMEOUT_WEBGL = 37447.0